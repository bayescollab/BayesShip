...
dataTrue = np.loadtxt("data/DiffEv_testing_true_data.csv",delimiter=',')
dataResampled = np.loadtxt("data/DiffEv_testing_resampled.csv",delimiter=',')
...
plt.savefig("plots/DiffEv_comparison.pdf")
plt.close()
